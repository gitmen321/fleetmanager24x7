...
Future<void> main() async {
  ...
  try {
    ...
    if (dbAndCollection['db'] == null || dbAndCollection['collection_drivers'] == null) {
      throw Exception('Failed to connect to MongoDB or initialize collections.');
    }
    ...
    print('Failed to connect to MongoDB: $e');
    // Optionally, show a message or handle this scenario more gracefully
    // You could show a snackbar or alert to inform the user
  }

  // Ensure orientation lock before running the app
  SystemChrome.setPreferredOrientations([DeviceOrientation.portraitUp]);

  // Only run the app if connection was successful
  runApp(const MyApp());
}
